...
class AbilityEditRequest extends FormRequest
{
    function attributes() {
        return [
    ...
    function messages() {
        ...
        $unique   = 'The field :attribute must be unique in the ability table.';
    ...
    {
        return [
            'name'          => 'required|min:2|max:100|unique:ability,name,' . $this->ability->id,
